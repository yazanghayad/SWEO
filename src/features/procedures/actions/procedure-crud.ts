...
export async function listProceduresAction(
  ...
  try {
    ...
    logger.error('listProceduresAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to list procedures')
    };
  }
}
...
export async function getProcedureAction(
  ...
  try {
    ...
    logger.error('getProcedureAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to get procedure')
    };
  }
}
...
export async function createProcedureAction(
  ...
  try {
    ...
    logger.error('createProcedureAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to create procedure')
    };
  }
}
...
export async function updateProcedureAction(
  ...
  try {
    ...
    logger.error('updateProcedureAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to update procedure')
    };
  }
}
...
export async function deleteProcedureAction(
  ...
  try {
    ...
    logger.error('deleteProcedureAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to delete procedure')
    };
  }
}
