...
export async function listPoliciesAction(
  ...
  try {
    ...
    logger.error('listPoliciesAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to list policies')
    };
  }
}
...
export async function getPolicyAction(
  ...
  try {
    ...
    logger.error('getPolicyAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to get policy')
    };
  }
}
...
export async function createPolicyAction(
  ...
  try {
    ...
    logger.error('createPolicyAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to create policy')
    };
  }
}
...
export async function updatePolicyAction(
  ...
  try {
    ...
    logger.error('updatePolicyAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to update policy')
    };
  }
}
...
export async function deletePolicyAction(
  ...
  try {
    ...
    logger.error('deletePolicyAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to delete policy')
    };
  }
}
