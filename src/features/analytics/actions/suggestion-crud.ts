...
export async function listSuggestionsAction(
  ...
  try {
    ...
    logger.error('listSuggestionsAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to list suggestions')
    };
  }
}
...
export async function approveSuggestionAction(
  ...
  try {
    ...
    return { success: true, sourceId: result.data?.sourceId };
  } catch (err) {
    logger.error('approveSuggestionAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to approve suggestion')
    };
  }
}
...
export async function dismissSuggestionAction(
  ...
  try {
    ...
    logger.error('dismissSuggestionAction error', { err });
    return {
      success: false,
      error: safeError(err, 'Failed to dismiss suggestion')
    };
  }
}
