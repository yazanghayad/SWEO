/**
 * Shared helpers for testing server actions.
 *
 * Mirrors the pattern used in guidance & knowledge actions:
 * ActionResult<T>, serialize(), toErrorMessage().
 */
...
/** Path used in revalidatePath() after testing mutations. */
export const TESTING_PATH = '/dashboard/testing';
