...
export default function ReportSweoDeflection() {
  return (
    <ReportShell
      title='SWEO AI Deflection'
          ...
          <div className='space-y-6'>
            ...
            <Card>
              <CardContent className='p-4'>
                ...
                <div className='bg-muted mt-3 h-1.5 w-full overflow-hidden rounded-lg'>
                  <div
                    className='bg-foreground h-full rounded-lg transition-all'
                    style={{
